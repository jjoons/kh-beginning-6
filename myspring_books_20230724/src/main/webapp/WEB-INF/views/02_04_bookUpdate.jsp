...
<script src="${cp}/resources/jq/jquery.form.min.js"></script>
<script src="${cp}/resources/js/02_02_bookregist.js"></script>

<script src="${cp}/resources/js/02_04_bookupdate.js"></script>
...
<form id="upForm1" action="managerBookUpdatePro.do" 
